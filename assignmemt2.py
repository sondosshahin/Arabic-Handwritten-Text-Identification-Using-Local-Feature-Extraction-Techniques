...
# Step 2: Cluster Descriptors (K-Means for BoW)
...
#  Train & Evaluate as SVM Classifier
...
best_model.fit(X_train_bow, y_train)  # Train on train + validation
test_predictions = best_model.predict(X_test_bow)
